...
const LANDING_NICHE_STATIC = [
  ...
  },
  {
    ...
    cards: [
      ...
      {
        type: 'multi',
        img: '/assets/images/big-brother-brasil.png',
        rowPcts: [41, 33, 26],
        volValue: '$14k',
      },
      ...
      cards: [
        {
          ...
          cat: t('Sports'),
          rows: ['Mbappé', 'Vinicius', 'Bellingham'],
        },
        {
    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          cat: 'UK',
          rows: [t('Labour'), t('Conservatives'), t('Other')],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          cat: 'DAO',
          rows: ['Ethereum', 'Arbitrum', 'Polygon'],
        },
        {
  ...
  const solutionPoints = [
    {
      ...
      copy: t(
        'Sports, crypto, politics, memes — anything your audience already argues about. You set the questions, the fee rate, and your brand.',
      ),
    },
    {
      title: t('Go live — we handle the infrastructure'),
      copy: t(
        'Settlement, wallets, liquidity, blockchain — all running before you finish setup. Your market is live in under 15 minutes with no code.',
      ),
    },
    {
      title: t('Every trade pays you directly'),
      copy: t(
        'Your audience bets. The fee goes straight to your wallet. No intermediary, no revenue share, no waiting.',
      ),
    },
  ]
  ...
  const featureCards = [
    {
      ...
      copy: t(
        'Custom domain, logo, colors, and UI language. Available in English, Portuguese, Spanish, German, French, Japanese, Chinese, Arabic, Russian, Italian, and Polish out of the box.',
      ),
    },
    {
      title: t('Shared liquidity from day one.'),
      copy: t(
        'Mirror active Polymarket markets with built-in order flow. Your site feels live the moment it launches — no cold start, no empty order books.',
      ),
    },
    {
      title: t('Leaderboard + PnL built in.'),
      copy: t(
        'Trader rankings, profit and loss tracking, and activity feeds are live by default. Your community has a reason to keep coming back.',
      ),
    },
    {
      title: t('On-chain affiliate system.'),
      copy: t(
        'Let others promote your market and earn a share of fees — settled trustlessly on-chain. No manual payouts, no spreadsheets.',
      ),
    },
    {
      title: t('Bot SDKs for automated trading.'),
      copy: t(
        'Python and Rust SDKs let market makers and power users run bots directly on your platform — increasing volume and depth automatically.',
      ),
    },
    {
      title: t('OpenZeppelin-audited contracts.'),
      copy: t(
        "Smart contracts derived from Polymarket's architecture. UMA-based resolution for transparent, verifiable market settlement. You don't need to know any of this — it just works.",
      ),
    },
  ]
    ...
    },
    {
      ...
      a: t.rich(
        'The codebase is open source under the <license>Kuest MIT+Commons license</license>. Forks for branding, frontend changes, and custom UX are welcome. Production deployments, however, must use Kuest infrastructure. Running an independent trading stack requires a separate <contact>commercial agreement</contact>.',
        {
          ...
          contact: (chunks) => <a href="mailto:hello@kuest.com">{chunks}</a>,
        },
      ),
    },
  ]
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: serializeJsonForHtmlScript({
            ...
            url: siteOrigin,
            description: t(
              'Create your own white-label prediction market in 15 minutes. Launch under your brand, set your fees, use your domain, and start with shared liquidity from day one.',
            ),
            offers: {
              '@type': 'Offer',
              price: '0',
              ...
              <div className="r hero-copy">
                ...
                <div className="hero-copy-side">
                  <p className="hero-copy-sub text-[clamp(17px,1.75vw,20px)] leading-[1.55] text-muted">
                    {t(
                      'Your audience already predicts things every day. Launch your own market for any niche — crypto, sports, politics, anything — and earn a fee on every trade.',
                    )}
                  </p>
            ...
            <div className="panel-inner max-w-295 grid-cols-1 gap-10">
              <div className="r text-center">
                ...
                <p className="bt section-copy-center">
                  {t(
                    'From the trading engine to your leaderboard, every feature you’d expect from a trading platform is already running. You just add your brand.',
                  )}
                </p>
              </div>
            ...
            <div className="panel-inner preview-section site-demo-section max-w-[95vw]! grid-cols-1 gap-10">
              <div className="site-demo-copy">
                <div className="site-demo-copy-inner">
                  ...
                  <p className="bt">
                    {t(
                      'This is a functional demo with mirrored Polymarket markets. Explore it, trade on it, and imagine it with your brand, your audience, and your questions.',
                    )}
                  </p>
                </div>
              </div>
