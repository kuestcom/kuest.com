  ...
  const protocolCards = [
    {
      ...
      tags: [t("Own brand"), t("Shared liquidity")],
    },
    {
      ...
      tags: [t("Operators"), t("Distribution"), t("Network scale")],
    },
    {
      ...
      tags: [t("SDK"), t("Bots"), t("API"), t("Mainnet")],
    },
  ];
  ...
  const businessModelCards = [
    {
      ...
      tags: [t("0.5%—3% operator fee"), t("Protocol take rate")],
    },
    {
      ...
      tags: [t("Free launch"), t("Usage-based")],
    },
    {
      ...
      tags: [t("Spread capture"), t("Network effects")],
    },
  ];
  ...
  const statusItems = [
    ...
    },
    {
      ...
      detail: t.rich("<link>github.com/kuestcom/prediction-market</link>", {
        link: (chunks) => <a href="https://github.com/kuestcom/prediction-market">{chunks}</a>,
      }),
      complete: true,
    },
    {
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: serializeJsonForHtmlScript({
            ...
            description: t(
              "White-label prediction market protocol for operators who want branded markets, shared liquidity, and protocol infrastructure.",
            ),
            offers: {
              "@type": "Offer",
              price: "0",
            ...
            <div className="panel-inner hero-stack">
              <div className="r hero-copy protocol-hero-copy">
                ...
                <div className="hero-copy-side protocol-hero-side">
                  <p className="hero-copy-sub protocol-hero-sub">
                    {t(
        ...
        <section className="panel-wrap panel-static protocol-section" id="p5">
          <div className="panel-sticky">
            <div className="panel-inner protocol-section-center">
              ...
              <div className="r rd2 protocol-context-line">
                {t(
                  "Currently, infrastructure costs are manageable and predictable. They will scale with volume - but so does protocol revenue, proportionally. The cost structure is not a ceiling; it is a variable that tracks growth.",
                )}
              </div>
            </div>
          </div>
        ...
        <section className="panel-wrap panel-static panel-compact" id="p9">
          <div className="panel-sticky">
            <div className="cta-content r v py-12">
              <h2 className="cta-h">
                {t("The infrastructure layer for prediction markets is being built right now.")}
              </h2>
              <p className="cta-sub">
                {t(
