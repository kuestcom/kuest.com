  ...
  const featureCards = [
    {
      ...
      copy: t('Custom domain, logo, colors, and UI language. Available in English, Portuguese, Spanish, German, French, Japanese, and Chinese out of the box.'),
    },
    {
  ...
  return (
    <>
      ...
      {proseLines.map((line, index) => {
        ...
        const sentenceBreakMatch = idx !== -1
          ? [
              line,
              line.slice(0, idx + 1),
              line.slice(idx).trimStart(),
            ]
          : null
