...
import {
  defaultSiteLocale,
  getLandingMessages, getSiteOrigin,
  isSiteLocale, localeHref, type SiteLocale, siteLocales,
} from "@/i18n/site";
import {
  buildEmbedPreviewBootstrapScript,
  buildLandingNiches,
  buildLandingProofCards, buildThemeBootstrapScript,
  getDemoEmbedSrc,
  getDemoHref,
  getDemoLabel,
  getLandingHeroAccent, sanitizeTranslatedHtml, serializeJsonForHtmlScript, stripTerminalPeriod, stripTrailingArrow
