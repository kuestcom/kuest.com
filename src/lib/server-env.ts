...
export function getPublicRuntimeConfig(): PublicRuntimeConfig {
  ...
  return {
    ...
    DEFAULT_VERCEL_TEAM_ID: readString('DEFAULT_VERCEL_TEAM_ID', PUBLIC_RUNTIME_DEFAULTS.DEFAULT_VERCEL_TEAM_ID),
    DEFAULT_VERCEL_REGION: readString('DEFAULT_VERCEL_REGION', PUBLIC_RUNTIME_DEFAULTS.DEFAULT_VERCEL_REGION),
    DEFAULT_SUPABASE_REGION: readString('DEFAULT_SUPABASE_REGION', PUBLIC_RUNTIME_DEFAULTS.DEFAULT_SUPABASE_REGION),
...
export function getServerRuntimeConfig() {
  return {
    ...
    VERCEL_SUPABASE_REGION: readString('VERCEL_SUPABASE_REGION', PUBLIC_RUNTIME_DEFAULTS.DEFAULT_SUPABASE_REGION),
    VERCEL_SUPABASE_PUBLIC_ENV_VAR_PREFIX: readString('VERCEL_SUPABASE_PUBLIC_ENV_VAR_PREFIX', 'NEXT_PUBLIC_'),
    ...
    RATE_LIMIT_SUPABASE_RESOURCES_MAX: readPositiveInteger('RATE_LIMIT_SUPABASE_RESOURCES_MAX', 240),
